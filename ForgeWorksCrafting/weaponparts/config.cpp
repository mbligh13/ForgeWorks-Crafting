...
// =====================================================
    ...
    class FW_Spring_Small: FW_PartBase
    {
        ...
        model = "weaponparts\data\models\small_spring.p3d";
    ...
    class FW_Spring_Large: FW_PartBase
    {
        ...
        model = "weaponparts\data\models\large_spring.p3d";
        // Empty to allow engine to use model InvView
        inventoryIcon[] = {};
        weight = 80;
        itemSize[] = {1,2};
    ...
    class FW_SheetMetal_Small: FW_PartBase
    {
        ...
        model = "weaponparts\data\models\small_sheet_metal.p3d";
        // Empty to allow engine to use model InvView
        inventoryIcon[] = {};
        weight = 100;
        itemSize[] = {2,1};
...
// =====================================================
    ...
    class FW_PistolReceiver_Base: FW_PartBase
    {
        ...
        model = "weaponparts\data\models\pistol_reciever.p3d";
        // Empty to allow engine to use model InvView
        inventoryIcon[] = {};
        weight = 250;
        itemSize[] = {2,1};
    ...
    {
        scope = 0;
        model = "weaponparts\data\models\pistol_handle.p3d";
        // Empty to allow engine to use model InvView
        inventoryIcon[] = {};
        weight = 200;
        itemSize[] = {1,2};
...
// =====================================================
    ...
    {
        scope = 0;
        model = "weaponparts\data\models\barrel.p3d";
        // Empty to allow engine to use model InvView
        inventoryIcon[] = {};
        weight = 350;
        itemSize[] = {3,1};
...
// =====================================================
    ...
    {
        scope = 0;
        model = "weaponparts\data\models\lower_receiver.p3d";
        // Empty to allow engine to use model InvView
        inventoryIcon[] = {};
        weight = 350;
        itemSize[] = {2,2};
...
// =====================================================
    ...
    {
        scope = 0;
        model = "weaponparts\data\models\upper_receiver.p3d";
        // Empty to allow engine to use model InvView
        inventoryIcon[] = {};
        weight = 380;
        itemSize[] = {2,2};
...
// =====================================================
    ...
    {
        scope = 0;
        model = "weaponparts\data\models\bolt.p3d";
        // Empty to allow engine to use model InvView
        inventoryIcon[] = {};
        weight = 200;
        itemSize[] = {1,2};
