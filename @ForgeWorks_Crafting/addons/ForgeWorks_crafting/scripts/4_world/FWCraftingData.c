...
// Path: scripts/4_world/FWCraftingData.c

// ============================================
// CRAFTING INGREDIENT
// ============================================
class FWCraftingIngredient
{
    protected string m_ClassName;
    protected int m_Amount;
    protected string m_DisplayName;
    
    void FWCraftingIngredient(string className, int amount)
    {
...
class FWCraftingRecipe
{
    ...
    protected ref array<ref FWCraftingIngredient> m_Ingredients;
    protected ref array<string> m_Results;
    
    void FWCraftingRecipe()
    {
        m_Ingredients = new array<ref FWCraftingIngredient>;
    ...
    {
        m_Ingredients.Insert(new FWCraftingIngredient(className, amount));
    }
    ...
    array<ref FWCraftingIngredient> GetIngredients()
    {
...
// CRAFTING CATEGORY
// ============================================
class FWCraftingCategory
{
    protected string m_Name;
    protected string m_IconPath;
    protected ref array<string> m_SubCategories;
    
    void FWCraftingCategory(string name, string iconPath = "")
    {
        m_Name = name;
        m_IconPath = iconPath;
...
// ============================================
class FWWorkbenchPosition
{
    vector m_Position;
    vector m_Orientation;
    string m_MapName;
    
    void FWWorkbenchPosition(vector pos, vector ori, string mapName = "")
    {
        m_Position = pos;
        m_Orientation = ori;
        m_MapName = mapName;
