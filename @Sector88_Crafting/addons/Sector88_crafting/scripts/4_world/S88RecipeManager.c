...
class S88RecipeManager
{
    ...
    protected void LoadMagazineRecipes()
    {
        ...
        pistolMag.SetIconPath("set:dayz_inventory image:mag_glock");        pistolMag.AddIngredient("S88_SheetMetal_Small", 1);
        ...
        arMag.SetIconPath("set:dayz_inventory image:mag_stanag_30rnd");        arMag.AddIngredient("S88_SheetMetal_Small", 1);
        ...
        arMagExt.SetIconPath("set:dayz_inventory image:mag_cmag_60rnd");        arMagExt.AddIngredient("S88_SheetMetal_Small", 2);
        ...
        drumMag.SetIconPath("set:dayz_inventory image:mag_ak74_drum75rnd");        drumMag.AddIngredient("S88_SheetMetal_Large", 2);
