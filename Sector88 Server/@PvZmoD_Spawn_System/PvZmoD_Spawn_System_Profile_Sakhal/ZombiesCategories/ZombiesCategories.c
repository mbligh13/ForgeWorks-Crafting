...
ref autoptr TStringArray Zombie_Type_Spooky = { 
	"ZmbM_Mummy",	
};
ref autoptr TStringArray Zombie_Type_Santa = { 
	"ZmbM_Santa",	
};

/// ////////////// Toxic zones //////////////////
ref autoptr TStringArray Zombie_Type_NBC_Weak = { 			
	"ZmbM_NBC_Yellow",	
	"ZmbM_NBC_White",
};
ref autoptr TStringArray Zombie_Type_NBC_Strong = { 			
	"ZmbM_NBC_Grey",	
};

/// ////////////// Countryside //////////////////
ref autoptr TStringArray Zombie_Type_Countryside_Weak = { 	
...
ref autoptr TStringArray Zombie_Type_Countryside_Strong = { 	
...
/// ///////////////// Police ///////////////
ref autoptr TStringArray Zombie_Type_Police_Weak = {
	"ZmbM_PolicemanFat",
	"ZmbF_PoliceWomanNormal",	
};
ref autoptr TStringArray Zombie_Type_Police_Strong = {
	"ZmbM_PolicemanSpecForce",
	"ZmbM_PolicemanSpecForce_Heavy",	
};
...
/// ///////////////// Military ///////////////
ref autoptr TStringArray Zombie_Type_MilitaryDyna_Weak = {
...
ref autoptr TStringArray Zombie_Type_MilitaryDyna_Strong = {
...
ref autoptr TStringArray Zombie_Type_Hospital_Medium = {   	
...
ref autoptr TStringArray Zombie_Type_Hospital_Strong = {  	
	"ZmbM_DoctorFat",
...
/// //////////////// GazStation ////////////////
ref autoptr TStringArray Zombie_Type_GazStation_Weak = {
	"ZmbF_BlueCollarFat_Blue",
	"ZmbF_BlueCollarFat_Green",
	"ZmbF_BlueCollarFat_Red",
...
ref autoptr TStringArray Zombie_Type_GazStation_Strong = {
	"ZmbM_FirefighterNormal",
};
