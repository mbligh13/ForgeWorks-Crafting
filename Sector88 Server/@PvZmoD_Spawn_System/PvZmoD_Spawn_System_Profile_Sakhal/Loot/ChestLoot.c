...
ref autoptr TStringArray data_Chest005 = { "All","Normal","CarBattery","PressVest_Blue", }; // Radio
ref autoptr TStringArray data_Chest006 = { "All","Normal","NailBox","SparkPlug", }; // Industrial
ref autoptr TStringArray data_Chest007 = { "All","Normal","FirefighterAxe", }; // FireStation
ref autoptr TStringArray data_Chest008 = { "All","Normal","AntiChemInjector","GasMask_Filter", }; // Toxic zones
ref autoptr TStringArray data_Chest009 = { "All","Normal","AKM","Mag_AKM_30Rnd", "AK_Suppressor", "AK_Woodbttstck", "AK_WoodHndgrd", "CanisterGasoline", }; // Military base (with gasoline for generator)
