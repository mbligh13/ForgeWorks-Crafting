...
ref autoptr TIntArray data_CountrySide =	{ 1,		300,		600,		1,			1,			400,		3,				30,					1 };			// 1 DEFAULT (Countryside)

ref autoptr TIntArray data_SmallTwon =		{ 10,		15,			20,			2,			3,			100,		3,				100,				10 };			// 10 SmallTwon
ref autoptr TIntArray data_AverageTown =	{ 20,		20,			25,			2,			4,			100,		5,				50,					20 };			// 20 AverageTown
ref autoptr TIntArray data_BigTown =		{ 30,		15,			20,			4,			6,			100,		10,				50,					30 };			// 30 BigTown
ref autoptr TIntArray data_Building =		{ 40,		20,			20,			5,			7,			100,		10,				50,					40 };			// 40 Building
ref autoptr TIntArray data_Industial =		{ 50,		10,			15,			3,			4,			100,		5,				50,					50 };			// 50 Industial
ref autoptr TIntArray data_Military =		{ 60,		15,			20,			3,			5,			100,		5,				50,					60 };			// 60 Military (always focus)
ref autoptr TIntArray data_Fog =			{ 70,		0,			0,			0,			0,			0,			0,				0,					0 };			// 70 
ref autoptr TIntArray data_Prison =			{ 71,		0,			0,			0,			0,			0,			0,				0,					0 };			// 71 (always focus)
...
ref autoptr TIntArray data_Config90 =		{ 90,		0,			0,			0,			0,			0,			0,				0,					0 };			// 90 
