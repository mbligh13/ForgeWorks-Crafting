...
ref autoptr TStringArray data_Chest002 = { "All","Normal","AKM","Mag_AKM_30Rnd", "AK_Suppressor", "AK_Woodbttstck", "AK_WoodHndgrd", }; // Villa
ref autoptr TStringArray data_Chest003 = { "All","Normal","NailBox","NailBox", }; // Industrial
