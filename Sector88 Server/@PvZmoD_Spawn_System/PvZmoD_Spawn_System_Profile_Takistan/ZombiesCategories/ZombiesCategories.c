...
ref autoptr TStringArray Zombie_Type_Hunter = {
	"ZmbM_HunterOld_Autumn",
	"ZmbM_HunterOld_Spring",
	"ZmbM_HunterOld_Summer",
};

ref autoptr TStringArray Zombie_Type_Desert_Low = {
...
ref autoptr TStringArray Zombie_Type_Medical_Low = {
	"ZmbM_PatientSkinny",
	"ZmbF_NurseFat",
	"ZmbF_DoctorSkinny",	
};
ref autoptr TStringArray Zombie_Type_Medical_Hight = {
...
ref autoptr TStringArray Zombie_Type_Bonfire = {
	"ZmbM_FirefighterNormal",
};
...
ref autoptr TStringArray Zombie_Type_Villa_Low = {
	"ZmbF_CitizenBSkinny",
};
ref autoptr TStringArray Zombie_Type_Villa_Hight = {
	"ZmbM_Jacket_beige",
	"ZmbM_Jacket_black",
	"ZmbM_Jacket_blue",
