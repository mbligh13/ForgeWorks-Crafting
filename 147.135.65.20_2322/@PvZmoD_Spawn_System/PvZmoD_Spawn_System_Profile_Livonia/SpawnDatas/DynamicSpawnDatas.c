...
ref autoptr TIntArray data_SmallTwon =		{ 10,		15,			20,			2,			3,			100,		10,				30,					10 };			// 10 SmallTwon
ref autoptr TIntArray data_AverageTown =	{ 20,		10,			15,			2,			5,			100,		5,				30,					20 };			// 20 AverageTown
ref autoptr TIntArray data_BigTown =		{ 30,		10,			15,			3,			7,			100,		10,				30,					30 };			// 30 BigTown
ref autoptr TIntArray data_Building =		{ 40,		0,			0,			0,			0,			0,			0,				0,					0 };			// 40 
...
ref autoptr TIntArray data_Config99 =		{ 99,		15,			20,			1,			2,			100,		20,				30,					99 };			// 99 Toxic zones (always focus) (v1.14 update)
