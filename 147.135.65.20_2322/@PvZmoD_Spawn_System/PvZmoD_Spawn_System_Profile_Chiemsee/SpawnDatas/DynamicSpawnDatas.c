...
ref autoptr TIntArray data_CountrySide =	{ 1,		600,		900,		15,			25,			300,		15,				20,					1 };			// 1 DEFAULT (Countryside)

ref autoptr TIntArray data_SmallTwon =		{ 10,		15,			20,			8,			12,			100,		10,				30,					10 };			// 10 SmallTwon
ref autoptr TIntArray data_AverageTown =	{ 20,		10,			15,			12,			16,			100,		5,				30,					20 };			// 20 AverageTown
ref autoptr TIntArray data_BigTown =		{ 30,		10,			15,			16,			20,			100,		10,				30,					30 };			// 30 BigTown
ref autoptr TIntArray data_Building =		{ 40,		20,			20,			5,			7,			100,		10,				30,					40 };			// 40 Building

ref autoptr TIntArray data_Industial =		{ 50,		10,			15,			6,			10,			100,		5,				30,					50 };			// 50 Industial
ref autoptr TIntArray data_Military =		{ 60,		10,			15,			10,			16,			80,			5,				30,					60 };			// 60 Military (always focus)
...
ref autoptr TIntArray data_Config90 =		{ 90,		10,			10,			8,			12,			600,		200,			200,				90 };			// 90 Camps
