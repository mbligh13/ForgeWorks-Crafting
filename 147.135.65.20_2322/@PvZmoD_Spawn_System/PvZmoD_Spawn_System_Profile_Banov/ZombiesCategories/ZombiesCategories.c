...
ref autoptr TStringArray Zombie_Type_Farmer = {
...
ref autoptr TStringArray Zombie_Type_Negan_Santuary = {
	"ZmbM_MotobikerFat_Beige",
	"ZmbM_MotobikerFat_Black",
	"ZmbM_MotobikerFat_Blue",
};

ref autoptr TStringArray Zombie_Type_NBC_Low = {
	"ZmbM_NBC_Yellow",	
};
ref autoptr TStringArray Zombie_Type_NBC_Hight = {
	"ZmbM_NBC_Grey",	
};
