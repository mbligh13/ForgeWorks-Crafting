...
ref autoptr TStringArray zombieList_02 	= {"ZmbM_NBC_Yellow","ZmbM_NBC_Grey","ZmbM_NBC_White",};
...
ref autoptr TStringArray itemList_06 	= {"0.7","Random","NailBox","NailBox","NailBox","BurlapSack","DuctTape","Hammer","Pliers","SparkPlug","SparkPlug","CarBattery","CanisterGasoline","PipeWrench","Pipe","CarRadiator","CarRadiator","TruckBattery",}; 
...
ref autoptr TStringArray itemList_09 	= {"0.5","Pristine","Ammo_9x19","Ammo_9x39","Ammo_762x39",};
...
ref autoptr TStringArray headgearList_09= {"0.2","Random","Ssh68Helmet","Ssh68Helmet","Ssh68Helmet","ZSh3PilotHelmet_Black","ZSh3PilotHelmet_Green",};
...
ref autoptr TStringArray zombieList_15 	= {"ZmbM_usSoldier_Officer_Desert","ZmbM_usSoldier_Officer_Convoy",};
ref autoptr TStringArray itemList_15	= {"0.3","BadlyDamaged","Mag_AKM_30Rnd",};
ref autoptr TStringArray vestList_15 	= {"0.1","Random","AK_Suppressor","PistolSuppressor",};
ref autoptr TStringArray backList_15 	= {"0.5","Random","AviatorGlasses",};
ref autoptr TStringArray headgearList_15= {"1.0","Random","OfficerHat",};

ref autoptr TStringArray zombieList_18 	= {"ZmbM_SoldierNormal",}; // is not a _base (is just one zombie)
ref autoptr TStringArray itemList_18 	= {"0.15","BadlyDamaged","Mag_AKM_30Rnd",};
ref autoptr TStringArray vestList_18 	= {"0.3","Random","HighCapacityVest_Black","PlateCarrierVest", "SmershVest","UKAssVest_Black","UKAssVest_Camo",};
ref autoptr TStringArray backList_18 	= {"0.3","Random","AssaultBag_Black","AssaultBag_Green","AssaultBag_Ttsko","DesignerGlasses",};
ref autoptr TStringArray headgearList_18= {"0.2","Random","GasMask",};

ref autoptr TStringArray zombieList_17 	= {"ZmbM_PatrolNormal_Base",}; 
ref autoptr TStringArray itemList_17 	= {"0.10","BadlyDamaged","Mag_AKM_30Rnd",};
ref autoptr TStringArray vestList_17 	= {"0.3","Random","HighCapacityVest_Black","PlateCarrierVest", "SmershVest","UKAssVest_Black","UKAssVest_Camo",};
ref autoptr TStringArray backList_17 	= {"0.3","Random","AssaultBag_Black","AssaultBag_Green","AssaultBag_Ttsko","DesignerGlasses",};
ref autoptr TStringArray headgearList_17= {"0.2","Random","GasMask",};

ref autoptr TStringArray zombieList_16 	= {"ZmbM_usSoldier_normal_Base",}; // all other military zombies
ref autoptr TStringArray itemList_16	= {"0.5","Pristine","Ammo_9x19","Ammo_9x39","Ammo_762x39",};
ref autoptr TStringArray vestList_16 	= {"0.05","Random","AK_Suppressor","PistolSuppressor",};
ref autoptr TStringArray backList_16 	= {"0.5","Random","AviatorGlasses",};
ref autoptr TStringArray headgearList_16= {"0.2","Random","MilitaryBeret_CDF","MilitaryBeret_ChDKZ","MilitaryBeret_NZ","MilitaryBeret_Red","MilitaryBeret_UN","OfficerHat",};

ref autoptr TStringArray zombieList_19 	= {"ZmbM_HermitSkinny_Beige",};
ref autoptr TStringArray itemList_19 	= {"1.0","Ruined","Worm","AthleticShoes_Blue","CombatBoots_Grey","HikingBootsLow_Blue","JoggingShoes_Violet","JungleBoots_Brown","Sneakers_Red","Wellies_Brown","WorkingBoots_Yellow",};  
ref autoptr TStringArray vestList_19 	= {"0.0","Ruined","",};  /// GhillieHood_Tan (tete) / GhillieBushrag_Tan (epaules) / GhillieTop_Tan (buste) / GhillieSuit_Tan (total)
ref autoptr TStringArray backList_19 	= {"0.9","Ruined","GhillieBushrag_Tan","GhillieSuit_Tan","GhillieTop_Tan","GhillieBushrag_Mossy","GhillieSuit_Mossy","GhillieTop_Mossy","GhillieBushrag_Woodland","GhillieSuit_Woodland","GhillieTop_Woodland","GhillieBushrag_Tan","GhillieBushrag_Mossy","GhillieBushrag_Woodland","GhillieBushrag_Tan","GhillieBushrag_Mossy","GhillieBushrag_Woodland",}; 
ref autoptr TStringArray headgearList_19= {"0.75","Ruined","GhillieHood_Tan","GhillieHood_Mossy","GhillieHood_Woodland",}; 
...
ref autoptr TStringArray vestList_20 	= {"1.0","Random","SportGlasses_Black","SportGlasses_Blue","SportGlasses_Green","SportGlasses_Orange",};
ref autoptr TStringArray backList_20 	= {"0.2","Ruined","ChildBag_Blue","ChildBag_Green","ChildBag_Red",};
...
ref autoptr TStringArray itemList_21 	= {"0.2","Pristine","HockeyStick","Apple","Pear","Plum","Tomato","GreenBellPepper","Zucchini","SewingKit","WaterBottle","Rag",};
ref autoptr TStringArray vestList_21 	= {"0.0","Random","",};
ref autoptr TStringArray backList_21 	= {"0.2","Ruined","ChildBag_Blue","ChildBag_Green","ChildBag_Red",};
ref autoptr TStringArray headgearList_21= {"0.5","Random","BaseballCap_CMMG_Pink","BaseballCap_Pink","BaseballCap_Red","BaseballCap_Blue",};

ref autoptr TStringArray zombieList_22 	= {"ZmbM_Jacket_Base",}; 	
ref autoptr TStringArray itemList_22 	= {"0.2","Pristine","Kiwi","Apple","Pear","Plum","Tomato","GreenBellPepper","Zucchini","SewingKit","WaterBottle","Rag",};
ref autoptr TStringArray vestList_22 	= {"0.0","Random","",};
ref autoptr TStringArray backList_22 	= {"0.0","Random","",};
ref autoptr TStringArray headgearList_22= {"0.3","Random","",};

ref autoptr TStringArray zombieList_23 	= {"ZmbF_ShortSkirt_Base",}; 	
ref autoptr TStringArray itemList_23 	= {"0.2","Pristine","Kiwi","Apple","Pear","Plum","Tomato","GreenBellPepper","Zucchini","SewingKit","WaterBottle","Rag",};
ref autoptr TStringArray vestList_23 	= {"0.0","Random","",};
ref autoptr TStringArray backList_23	= {"0.0","Random","",};
ref autoptr TStringArray headgearList_23= {"0.8","Random","ThinFramesGlasses","ThickFramesGlasses",};

ref autoptr TStringArray zombieList_24 	= {"ZmbM_MechanicSkinny_Base","ZmbF_BlueCollarFat_Blue",}; 				
ref autoptr TStringArray itemList_24 	= {"0.7","SparkPlug","SparkPlug","CarBattery","CanisterGasoline","LugWrench","CarRadiator","TruckBattery","TireRepairKit",}; 	
...
ref autoptr TStringArray itemList_25 	= {"1.0","Random","BaseballBat","BaseballBat","BaseballBat","NailedBaseballBat","NailedBaseballBat","BarbedBaseballBat",};
...
ref autoptr TStringArray itemList_26 	= {"20.0","Pristine","Guts","HumanSteakMeat","Bone",};
