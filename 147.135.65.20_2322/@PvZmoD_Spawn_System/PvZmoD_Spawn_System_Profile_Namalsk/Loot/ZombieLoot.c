...
ref autoptr TStringArray itemList_08 	= {"0.2","Pristine","LeatherSewingKit","Megaphone","Rag","Rag","Rag","Rag","FirefighterAxe","Flaregun","Ammo_Flare","Ammo_FlareRed","Ammo_FlareGreen","Ammo_FlareBlue",}; 
